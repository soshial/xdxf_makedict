...
std::pair<UniToStrPair *, UniToStrPair *> ipa_to_unicode_tbl()
{
	static UniToStrPair ipa_to_unicode_tbl[] = {
		...
		//ipa_to_unicode_make_pair( 0x0028), 0x026a) );
		//ipa_to_unicode_make_pair( 0x0029), 0x0259) );
		//ipa_to_unicode_make_pair( 0x002c), 0x02cc) );
		//ipa_to_unicode_make_pair( 0x002d), 0x003a) );
		...
		ipa_to_unicode_make_pair(0x0403, 0x003a),
